...
class CapitalismKasyno: public QObject
{
    Q_OBJECT
public:
     CapitalismKasyno(QThread *kasyno_, QSslSocket *mSocket_, QString nick_, std::string room_, QString data_, double betMoney_, CapitalismStorage* capitalismStorage_, CapitalismGame* capitalismGame_, QMutex *mutex_);
    ~CapitalismKasyno();
