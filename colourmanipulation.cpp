...
// \x02	bold \x03	colored text \x1D	italic text \x1F	underlined text \x16	swap background and foreground colors (“reverse video”) \x0F	reset all formatting
std::string ColourManipulation::addColours(std::string& line)
{
    std::cout << "ColourManipulation::addColours LINE I GET IN COLOURS: " << line << std::endl;
